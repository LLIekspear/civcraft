...
//			}
	...
	public void onHit(BlockBreakEvent event) {
		...
		if (hitpoints <= 0) {
			...
			CivMessage.sendCivRightMessage(owner.getCiv(), CivColor.Yellow+CivSettings.localize.localizedString("var_cannon_onHit_DestroyAlert",
					cannonLocation.getBlockX()+","+cannonLocation.getBlockY()+","+cannonLocation.getBlockZ()));
			return;
		}
		...
		CivMessage.sendCivRightMessage(owner.getCiv(), CivColor.LightGray+CivSettings.localize.localizedString("var_cannon_onHit_doDamageAlert",hitpoints+"/"+maxHitpoints,
				cannonLocation.getBlockX()+","+cannonLocation.getBlockY()+","+cannonLocation.getBlockZ()));
	}
