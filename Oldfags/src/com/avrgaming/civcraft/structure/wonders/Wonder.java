...
public abstract class Wonder extends Buildable {
	...
	public void processUndo() throws CivException {		
		try {
			...
			e1.printStackTrace();
			CivMessage.sendTownRightMessage(getTown(), CivColor.Rose+CivSettings.localize.localizedString("wonder_undo_error"));
	...
	public void processCoinsFromCulture() {
		...
		CivMessage.sendCivRightMessage(this.getCiv(), CivColor.LightGreen+CivSettings.localize.localizedString("var_colossus_generatedCoins",(CivColor.Yellow+total+CivColor.LightGreen),CivSettings.CURRENCY_NAME,cultureCount));
	}
