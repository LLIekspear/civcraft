...
public class NotreDame extends Wonder {
	...
	public void processPeaceTownCoins() {
		...
		CivMessage.sendTownRightMessage(this.getTown(), CivSettings.localize.localizedString("var_NotreDame_generatedCoins",totalCoins,CivSettings.CURRENCY_NAME,peacefulTowns));	
