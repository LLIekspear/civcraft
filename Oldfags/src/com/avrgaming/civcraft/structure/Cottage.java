...
//		attrComp.registerComponent();
	...
	public boolean processPoison(MultiInventory inv) {
		...
		if (max_poison_ticks > 0) {
			...
			CivMessage.sendTownRightMessage(this.getTown(), CivColor.Rose+CivSettings.localize.localizedString("cottage_poisoned"));
	...
	public void generateCoins(CivAsyncTask task) {
		...
		switch (result) {
		case STARVE:
			CivMessage.sendTownRightMessage(getTown(), CivColor.Rose+CivSettings.localize.localizedString("var_cottage_starved_base",getConsumeComponent().getLevel(),CivSettings.localize.localizedString("var_cottage_status_starved",getConsumeComponent().getCountString()),CivSettings.CURRENCY_NAME));
			return;
		case LEVELDOWN:
			CivMessage.sendTownRightMessage(getTown(), CivColor.Rose+CivSettings.localize.localizedString("var_cottage_starved_base",(getConsumeComponent().getLevel()+1),CivSettings.localize.localizedString("var_cottage_status_lvlDown"),CivSettings.CURRENCY_NAME));
			return;
		case STAGNATE:
			CivMessage.sendTownRightMessage(getTown(), CivColor.Rose+CivSettings.localize.localizedString("var_cottage_starved_base",getConsumeComponent().getLevel(),CivSettings.localize.localizedString("var_cottage_status_stagnated",getConsumeComponent().getCountString()),CivSettings.CURRENCY_NAME));
			return;
		case UNKNOWN:
			CivMessage.sendTownRightMessage(getTown(), CivColor.DarkPurple+CivSettings.localize.localizedString("var_cottage_starved_unknwon",CivSettings.CURRENCY_NAME));
			return;
		default:
			break;
		}
	...
	//	attrComp.setValue(total_coins);
		...
		if (taxesPaid > 0) {
			CivMessage.sendTownRightMessage(this.getTown(), CivColor.LightGreen+CivSettings.localize.localizedString("var_cottage_grew_base",getConsumeComponent().getLevel(),stateMessage,total_coins,CivSettings.CURRENCY_NAME,
