...
import com.avrgaming.civcraft.listener.MobLibListener;
import com.avrgaming.civcraft.listener.MobListener;
...
import ru.constellation.ellidey.log;
import ru.constellation.ellidey.packets.packetHandlerPlugin;
import ru.constellation.ellidey.packets.packetManager;
...
public final class CivCraft extends JavaPlugin {
	...
	public static packetHandlerPlugin packetHandler;
...
//		}
		...
		TaskMaster.syncTimer("ArenaTimeoutTimer", new ArenaTimer(), TimeTools.toTicks(1));
		  nextClearLagMobs = Calendar.getInstance().getTimeInMillis() + 1000 * 360 + 1; // ����� ��� (��� - ������)
	}
	...
	public void onEnable() {
		...
		log.init(this);
		setPlugin(this);
		packetHandler = new packetHandlerPlugin(this);
		
		new packetManager();
		Bukkit.getMessenger().registerOutgoingPluginChannel(plugin, "gui");
		Bukkit.getMessenger().registerIncomingPluginChannel(plugin, "gui", new packetHandlerPlugin(this));
	...
	public void onDisable() {
		super.onDisable();
		isDisable = true;
		Bukkit.getMessenger().unregisterIncomingPluginChannel(plugin, "gui");
		SQLUpdate.save();
