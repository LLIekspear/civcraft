...
public class SyncTradeTimer implements Runnable {
	...
	public void processTownsTradePayments(Town town) {
		...
		if (payment > 0.0) {
			...
			if (taxesPaid > 0) {
				CivMessage.sendTownRightChat(town, CivColor.LightGreen+CivSettings.localize.localizedString("var_syncTrade_payout",(CivColor.Yellow+df.format(payment)+CivColor.LightGreen+" "+CivSettings.CURRENCY_NAME),
